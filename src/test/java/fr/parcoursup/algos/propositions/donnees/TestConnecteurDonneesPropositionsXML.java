...
public class TestConnecteurDonneesPropositionsXML {
    ...
    public void recupererDonnees_doit_reussir() throws Exception {
        ...
        String testFilename = "/tmp/parcoursup-test-ConnecteurDonneesPropositionsXML-recupererDonnees_doit_ecrire_fichier.xml";
    ...
    public void recupererDonnees_doit_echouerSiMauvaisCheminDeFichier() throws Exception {
        ...
        // Deserialise
        ConnecteurDonneesPropositionsXML conn = new ConnecteurDonneesPropositionsXML("/tmp/fichier_inexistant.xml");
