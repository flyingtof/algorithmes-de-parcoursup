...
public class VerificationEntreeAlgoOrdreAppel {
    public static void verifier(AlgoOrdreAppelEntree entree) throws VerificationException {
        for(GroupeClassement groupe : entree.groupesClassements) {
            groupe.verifierCoherenceTaux();
            groupe.verifierRangs();
        }
    }    

    private VerificationEntreeAlgoOrdreAppel() {
    }
}
