...
--------------------------------------------------------
--  Contraintes sur la table A_ADM_DEM_RA
--------------------------------------------------------

ALTER TABLE "A_ADM_DEM_RA" ADD PRIMARY KEY ("G_CN_COD", "G_TA_COD", "I_RH_COD", "NB_JRS");

ALTER TABLE "A_ADM_DEM_RA" MODIFY ("G_CN_COD" NOT NULL ENABLE);
ALTER TABLE "A_ADM_DEM_RA" MODIFY ("G_TA_COD" NOT NULL ENABLE);
ALTER TABLE "A_ADM_DEM_RA" MODIFY ("I_RH_COD" NOT NULL ENABLE);
ALTER TABLE "A_ADM_DEM_RA" MODIFY ("NB_JRS" NOT NULL ENABLE);
ALTER TABLE "A_ADM_DEM_RA" MODIFY ("EST_DEM_PROP" NOT NULL ENABLE);
...
-- ALTER TABLE "A_ADM_DEM_RA" ADD CONSTRAINT FK_A_ADM_DEM_RA_G_CN_COD FOREIGN KEY (G_CN_COD) REFERENCES G_CAN(G_CN_COD);
-- ALTER TABLE "A_ADM_DEM_RA" ADD CONSTRAINT FK_A_ADM_DEM_RA_G_TI_COD FOREIGN KEY (G_TI_COD) REFERENCES G_TRI_INS(G_TI_COD);
-- ALTER TABLE "A_ADM_DEM_RA" ADD CONSTRAINT FK_A_ADM_DEM_RA_G_TA_COD FOREIGN KEY (G_TA_COD) REFERENCES G_TRI_AFF(G_TA_COD);
-- ALTER TABLE "A_ADM_DEM_RA" ADD CONSTRAINT FK_A_ADM_DEM_RA_C_GP_COD FOREIGN KEY (C_GP_COD) REFERENCES C_GRP(C_GP_COD);
-- ALTER TABLE "A_ADM_DEM_RA" ADD CONSTRAINT FK_A_ADM_DEM_RA_C_GI_COD FOREIGN KEY (C_GI_COD) REFERENCES A_REC_GRP_INT(C_GI_COD);
